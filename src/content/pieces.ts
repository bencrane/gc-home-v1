...
export const PIECES: Piece[] = [
  {
    ...
    body: [
      ...
      { kind: "chart", form: "ranked", heading: "Obligations by awarding agency · FY25", data: F(record), label: "agency", value: "obl", valueFormat: "money", source: SRC },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "change", heading: "Largest obligation movements by agency and industry · FY24 to FY25", data: flowsLabeled, label: "label", value: "delta", valueFormat: "money", source: SRC },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "timeline", heading: "Facilities support awards ending within 180 days · by end date", data: F(expiring), label: "recipient", date: "current_end_date", value: "current_value", valueFormat: "money", source: SRC },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "ranked", heading: "Sub-award volume under construction primes · trailing 24 months", data: F(subunder), label: "prime", value: "sub_amount", valueFormat: "money", source: "Source: USAspending, FSRS sub-award reports" },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "ranked", heading: "Largest new awards · May 2026", data: F(whowon), label: "recipient", value: "obligation", valueFormat: "money", source: SRC },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "dumbbell", heading: "Guard II · SCA floor vs Texas market median, by county", data: F(wage), label: "county_name", a: "floor_hourly", b: "market_median", aName: "SCA floor", bName: "Market median", valueFormat: "hourly", source: "Source: SAM.gov wage determinations; BLS OEWS state wages" },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "ranked", heading: "Obligations by awarding agency · FY24", data: F(record24), label: "agency", value: "obl", valueFormat: "money", source: SRC },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "ranked", heading: "Obligations by place of performance · FY25", data: statesNamed, label: "name", value: "obl", valueFormat: "money", source: SRC },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "timeline", heading: "Building construction awards ending within 180 days · by end date", data: F(exp236), label: "recipient", date: "current_end_date", value: "current_value", valueFormat: "money", source: SRC },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "timeline", heading: "Professional services awards ending within 180 days · by end date", data: F(exp541), label: "recipient", date: "current_end_date", value: "current_value", valueFormat: "money", source: SRC },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "ranked", heading: "Sub-award volume under remediation primes · trailing 24 months", data: F(sub562), label: "prime", value: "sub_amount", valueFormat: "money", source: "Source: USAspending, FSRS sub-award reports" },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "ranked", heading: "Sub-award volume under professional services primes · trailing 24 months", data: F(sub541), label: "prime", value: "sub_amount", valueFormat: "money", source: "Source: USAspending, FSRS sub-award reports" },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "ranked", heading: "Largest new awards · June 2026", data: F(won06), label: "recipient", value: "obligation", valueFormat: "money", source: SRC },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "ranked", heading: "Largest new awards · April 2026", data: F(won04), label: "recipient", value: "obligation", valueFormat: "money", source: SRC },
  ...
  },
  {
    ...
    body: [
      ...
      { kind: "chart", form: "dumbbell", heading: "Janitor · SCA floor vs California market median, by county", data: F(wageCa), label: "county_name", a: "floor_hourly", b: "market_median", aName: "SCA floor", bName: "Market median", valueFormat: "hourly", source: "Source: SAM.gov wage determinations; BLS OEWS state wages" },
